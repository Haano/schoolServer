...
exports.getFile = (req, res) => {
    ...
    let dirToFile = dir + "/NEWFILE" + req.files.file.name;

    // Use the mv() method to place the file somewhere on your server
    file.mv(dir + "/NEWFILE" + req.files.file.name, function(err) {
...
exports.sendFile = (req, res) => {
    ...
    // console.log("ЗАПРОС НА ОТПРАВКУ ФАЙЛА");
    // //let fileLocation = "uploads/6234cd958d9eadf938f025f5";

    // let file = "uploads/6234cd958d9eadf938f025f5/NEWFILE2022-03-03-sm.xlsx";
    // let fileLocation = file;
    // //const file = `uploads/6234cd958d9eadf938f025f5/NEWFILE2022-03-03-sm.xlsx.jpg`;
...
exports.createReciept = (req, res) => {
    ...
    reciept
        ...
        .catch((err) => {
            res.status(500).send({
                message: err.message || "Some error occurred while creating the ClassList.",
            });
        });
};
